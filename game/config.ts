export const CONFIG = {
  ...
  flashlight: {
    ...
    viewportAimMargin: 24, // wu the auto-aim viewport rect is expanded OUTWARD by — a zombie up to this far past the visible edge stays targetable (so one whose body is partly on-screen isn't ignored; ≈ a zombie radius) and it debounces the exact edge
  },
  heal: {
